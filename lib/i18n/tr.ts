...
export const tr = {
  ...
  "account.deleteTitle": "Hesabı ve verileri sil",
  "account.deleteEntry": "Hesabımı ve verilerimi sil",
  "account.deleteEntryDescription": "Hesabınla birlikte Firestore ve Paperlike Drive verilerini kalıcı olarak kaldır.",
  "account.deleteScopeDescription": "Uzak veriler her zaman silinir. Bu cihazdaki kitaplık için ayrıca seçim yapabilirsin.",
  "account.deleteRemoteWarning": "Firebase hesabın, bulut kitaplığın, notların, yer imlerin, ayarların ve varsa Drive'daki Paperlike klasörün kalıcı olarak silinecek. Bu işlem geri alınamaz.",
  "account.deleteLocalLabel": "Bu cihazdaki yerel kitaplığı da sil",
  "account.deleteLocalDescription": "İşaretlemezsen kitaplar ve okuma verileri cihazda kalır; uygulamayı misafir olarak kullanmaya devam edebilirsin.",
  "account.deleteContinue": "Devam et",
  "account.deleteBack": "Geri",
  "account.deleteFinalTitle": "Kalıcı silmeyi onayla",
  "account.deleteGoogleReauth": "Kimliğini doğrulamak için Google hesabını yeniden seçmen istenecek.",
  "account.deletePasswordReauth": "Kimliğini doğrulamak için mevcut şifreni gir.",
  "account.deleteFinalWarning": "Silme tamamlanana kadar uygulamayı kapatma. Uzak silme zinciri tamamlanamazsa hesabın korunur ve kalan kapsam açıkça bildirilir.",
  "account.deleteConfirm": "Kalıcı olarak sil",
  "account.deleting": "Siliniyor…",
  "account.deleteSuccessWithLocal": "Hesap, uzak veriler ve bu cihazdaki yerel kitaplık silindi.",
  "account.deleteSuccessKeepLocal": "Hesap ve uzak veriler silindi. Yerel kitaplık bu cihazda korundu.",
  "account.deletePartialLocal": "Hesap ve uzak veriler silindi; yerel kitaplık silinemedi ve bu cihazda kaldı.",
  "account.deleteError.reauthentication": "Kimlik yeniden doğrulanamadı. Hiçbir veri silinmedi; tekrar deneyebilirsin.",
  "account.deleteError.firestore": "Bulut verilerinin tamamı silinemedi. Hesabın korundu; bağlantını kontrol edip tekrar dene.",
  ...
  "syncStatus.retrying": "Bağlantı gelince değişiklikler yeniden denenecek.",
  "syncStatus.attention": "Bazı değişiklikler için müdahale gerekiyor.",
  "syncStatus.pending": "{count} değişiklik bekliyor.",
  "syncStatus.permission": "Google/Firebase erişim iznini yenileyip tekrar dene.",
  "syncStatus.quota": "Bulut depolama kotasını kontrol edip tekrar dene.",
  "syncStatus.network": "Son deneme ağ veya servis hatası nedeniyle tamamlanamadı.",
  "syncStatus.retryNow": "Şimdi tekrar dene",
  "syncStatus.retryingNow": "Deneniyor…",

  // Privacy / diagnostics
  "privacy.crashReportingTitle": "Gizlilik ve tanılama",
  "privacy.crashReportingToggle": "Kilitlenme raporlarını paylaş",
  "privacy.crashReportingDescription": "Android kilitlenme ve redakte edilmiş JavaScript hata raporlarını Firebase Crashlytics'e göndererek sorunları düzeltmemize yardımcı ol.",
  "privacy.crashReportingEnabledDetail": "Açık. Raporlar cihaz/uygulama sürümü ve teknik hata ayrıntıları içerebilir; cihazda bekleyen raporlar da gönderilebilir. Firebase, trace ve ilişkili kimlikleri 90 gün tutar.",
  "privacy.crashReportingDisabledDetail": "Kapalı. JavaScript hataları hemen gönderilmez; native otomatik toplama bir sonraki uygulama açılışında tamamen kapanır ve gönderilmemiş raporlar silinir.",
  "privacy.crashReportingEnabled": "Kilitlenme raporları açıldı.",
  "privacy.crashReportingDisabled": "Kilitlenme raporları kapatıldı. Değişiklik bir sonraki uygulama açılışında tamamen uygulanacak.",
  "privacy.crashReportingApplyError": "Tercihin kaydedildi ancak native ayar şu anda uygulanamadı; sonraki açılışta tekrar denenecek.",
